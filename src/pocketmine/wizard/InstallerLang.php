...
class InstallerLang
{
	...
	{
		if (file_exists(PATH . "src/pocketmine/lang/Installer/" . $lang . ".ini")) {
			$this->lang = $lang;
			$this->langfile = PATH . "src/pocketmine/lang/Installer/" . $lang . ".ini";
		} else {
			$files = [];
			foreach (new DirectoryIterator(PATH . "src/pocketmine/lang/Installer/") as $file) {
			...
			if (count($files) > 0) {
				...
				$this->langfile = PATH . "src/pocketmine/lang/Installer/" . $l . ".ini";
			} else {
				$this->lang = "en";
				$this->langfile = PATH . "src/pocketmine/lang/Installer/en.ini";
			}
		}

		$this->loadLang(PATH . "src/pocketmine/lang/Installer/en.ini", "en");
		if ($this->lang !== "en") {
